...
% straight through the block and blockentity boxes' text in between. Offset generously
% (1cm, not just enough to clear the nominal 6.2cm edge) since this exact arrow is what
% twice revealed a box quietly wider than intended - safety margin here is cheap.
\draw[-{Latex[length=2mm]}] (network.east) -- ++(1.0,0) |- (sim.east);
