...
\caption{The fifteen blocks and items provided by the mod as of its initial release; the AC
Source and AC Probe (Section~\ref{sec:ac-analysis}) were added in a later version and are not
yet pictured here.}
\label{fig:gallery}
\end{figure}
