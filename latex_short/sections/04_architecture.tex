...
branching in the algorithm above); two purely topological blocks (a wire, conductive on all
six faces with no orientation, and a ground block, identical to wire for topology but
additionally establishing the network's voltage reference); three independent voltage sources
(a fixed-DC power supply, a function generator producing sine/square/triangle waves whose
